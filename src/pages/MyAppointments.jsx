...
const MyAppointments = () => {
    ...
    return (
        <div className=''>
            <p className='pb-3 mt-12 text-zinc-700 border-b text-xl'>My Appoinments</p>
            <div>
                {
                    doctors.slice(0, 2).map((item, index) => (
                        <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
                            ...
                            <div className='flex flex-col gap-2 justify-end'>
                                <button className='border text-sm text-stone-500  text-center sm:min-w-48 py-2 hover:bg-primary hover:text-white transition-all duration-300'>Pay Online</button>
